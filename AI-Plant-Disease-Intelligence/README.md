...
```bash
# Download PlantVillage from Kaggle and place class folders in dataset/
python main.py train --data-dir dataset --backbone mobilenetv2 --epochs 15

# Predict one image with the saved .h5 model
python main.py predict path/to/leaf.jpg
```

This produces:

- `saved_models/plant_disease_mobilenet.h5`
- `saved_models/plant_disease_mobilenet.tflite`
- `plots/plant_disease_mobilenet_training_history.png`
